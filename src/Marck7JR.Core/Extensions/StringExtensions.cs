namespace Marck7JR.Core.Extensions
{
    ...
    {
        public static bool IsNotNullOrEmpty(this string? @string) => !@string.IsNullOrEmpty();
        public static bool IsNotNullOrWhiteSpace(this string? @string) => !@string.IsNullOrWhiteSpace();
